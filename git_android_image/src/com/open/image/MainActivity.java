...
public class MainActivity extends Activity {
	...
	private void initView()
	{
		...
		findViewById(R.id.cicular_imageView).setOnClickListener(listener);
		findViewById(R.id.cicular_imageView2).setOnClickListener(listener);
		findViewById(R.id.cicular_imageView3).setOnClickListener(listener);
		findViewById(R.id.cicular_imageView4).setOnClickListener(listener);
